...
export default function BrowsePage() {
  ...
  return (
    ...
    >
      <div
        className="min-h-screen flex w-full bg-white text-[#1A1A1A]"
        style={{ fontFamily: "var(--font-poppins), Poppins, sans-serif" }}
      >

      {/* ── LEFT SIDEBAR (Cream Box, White Space Below) ── */}
      ...
      {/* ── RIGHT MAIN CONTENT (Full Height, White Background) ── */}
      <div className="flex-1 flex flex-col min-w-0 bg-white">
        
        {/* Header */}
        <header className="flex items-center justify-between px-6 lg:px-10 h-[80px] pt-4">
          <button
          ...
          <div className="hidden md:flex flex-1 max-w-[600px]">
            <div className="flex items-center gap-3 w-full px-5 py-2.5 rounded-full border border-gray-200 bg-white transition-shadow focus-within:shadow-sm">
        ...
        <div className="px-6 lg:px-10 py-8">
          ...
          <section className="mb-14">
            <div
              className="relative w-full h-[280px] rounded-2xl border border-gray-100 overflow-hidden flex items-center justify-between px-12"
              style={{ backgroundColor: "#FFFFFF", boxShadow: "0 4px 24px rgba(0,0,0,0.02)" }}
            >
          ...
          <section className="mb-14">
            ...
            <div className="flex gap-5 md:gap-8 lg:gap-10 overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory">
              {["People", "History", "Politics", "Kids", "Education"].map((genre, i) => (
                ...
                >
                  <Image src={`/books/rec-book-${(i % 4) + 1}.png`} alt="" fill className="object-cover group-hover:scale-110 transition-transform duration-500" />
          ...
          <section id="newarrivals" className="mb-14">
            <SectionHeader title="New Arrivals" subtitle="Trending books among readers" loading={loading} />
          ...
          <section id="bestsellers" className="mb-16">
            <SectionHeader title="Our Best Sellers" subtitle="Trending books among readers" loading={loading} />
          ...
          {/* Crime Fiction */}
          <section className="mb-16">
            <SectionHeader title="Crime Fiction" subtitle="Trending books among readers" loading={loading} />
            <BookShelf books={crimeFiction} variant="large" loading={loading} />
          </section>

          {/* Non Fiction */}
          <section className="mb-16">
            <SectionHeader title="Non Fiction Books" subtitle="Trending books among readers" loading={loading} />
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory">
              {famousAuthors.map((author) => (
                <div key={author.id} className="snap-start">
                  <FamousAuthorCard id={author.id} name={author.name} photo={author.photo} loading={loading} />
                </div>
              ))}
            </div>
          </section>
          ...
          {/* Academics */}
          <section className="mb-16">
            <SectionHeader title="Academics" subtitle="Trending books among readers" loading={loading} />
            <BookShelf books={academics} variant="large" loading={loading} />
          </section>

          {/* Business */}
          <section id="business" className="mb-16">
            <SectionHeader title="Business" subtitle="Trending books among readers" loading={loading} />
            <BookShelf books={business} variant="large" loading={loading} />
          </section>

          {/* Tech */}
          <section id="tech" className="mb-16">
            <SectionHeader title="Tech Books" subtitle="Trending books among readers" loading={loading} />
            <BookShelf books={techBooks} variant="large" loading={loading} />
          </section>

          {/* Classics */}
          <section id="classics" className="mb-16">
            <SectionHeader title="Classics" subtitle="Trending books among readers" loading={loading} />
            <BookShelf books={classics} variant="large" loading={loading} />
          </section>
        </div>

        {/* Footer */}
        <footer className="bg-[#F8FAFC] py-16 px-10 border-t border-gray-100 relative overflow-hidden mt-auto">
          <svg className="absolute bottom-0 left-0 w-full h-[120px] pointer-events-none z-0 opacity-60" preserveAspectRatio="none" viewBox="0 0 1440 320">
            <defs>
            ...
            <path fill="url(#footerGradient)" fillOpacity="0.25" d="M0,288L48,272C96,256,192,224,288,197.3C384,171,480,149,576,165.3C672,181,768,235,864,250.7C960,267,1056,245,1152,250.7C1248,256,1344,288,1392,304L1440,320L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" />
          </svg>
          ...
          <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-20 justify-between relative z-10">
            <div className="max-w-[480px]">
              ...
              <p className="text-[15px] text-gray-500 leading-relaxed">
                Chai Reader is an AI-powered book commerce platform designed to transform how people discover and experience books. It is owned and operated by Ailaysa Technologies Pvt Ltd.
              </p>
            </div>

            <div className="flex flex-wrap md:flex-nowrap gap-10 lg:gap-20">
